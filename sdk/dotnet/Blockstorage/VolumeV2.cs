...
namespace Pulumi.Openstack.Blockstorage {
	...
	public sealed class VolumeV2Attachment : Pulumi.IIOProtobuf {
		...
		public static VolumeV2Attachment FromProtobuf(Google.Protobuf.WellKnownTypes.Value value) {
			var obj = value.StructValue;
			return new VolumeV2Attachment() {
	...
	/// </summary>
	public class VolumeV2 : Pulumi.CustomResource {
		/// <summary>
		/// If a volume is attached to an instance, this attribute will
		/// display the Attachment ID, Instance ID, and the Device as the Instance
		/// sees it.
		/// </summary>
		public Pulumi.IO<VolumeV2Attachment[]> Attachments { get; set; }
		...
		public VolumeV2(string name, VolumeV2Args args, Pulumi.ResourceOptions opts = default(Pulumi.ResourceOptions))
			: base("openstack:blockstorage/volumeV2:VolumeV2", name, SerialiseArgs(args), opts) {
			...
			Attachments = Outputs["attachments"].Select(item => Protobuf.ToList(item, item1 => VolumeV2Attachment.FromProtobuf(item1)));
			AvailabilityZone = Outputs["availabilityZone"].Select(item => Protobuf.ToString(item));
			ConsistencyGroupId = Outputs["consistencyGroupId"].Select(item => Protobuf.ToString(item));
			Description = Outputs["description"].Select(item => Protobuf.ToString(item));
			ImageId = Outputs["imageId"].Select(item => Protobuf.ToString(item));
		...
		private static Dictionary<string, Pulumi.IO<Google.Protobuf.WellKnownTypes.Value>> SerialiseArgs(VolumeV2Args args) {
