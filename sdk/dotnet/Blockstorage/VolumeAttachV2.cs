...
namespace Pulumi.Openstack.Blockstorage {
	...
	/// </summary>
	public struct VolumeAttachV2Args {
		/// <summary>
	...
	/// </summary>
	public class VolumeAttachV2 : Pulumi.CustomResource {
		/// <summary>
		/// Specify whether to attach the volume as Read-Only
		/// (`ro`) or Read-Write (`rw`). Only values of `ro` and `rw` are accepted.
		/// If left unspecified, the Block Storage API will apply a default of `rw`.
		...
		public VolumeAttachV2(string name, VolumeAttachV2Args args, Pulumi.ResourceOptions opts = default(Pulumi.ResourceOptions))
			: base("openstack:blockstorage/volumeAttachV2:VolumeAttachV2", name, SerialiseArgs(args), opts) {
		...
		private static Dictionary<string, Pulumi.IO<Google.Protobuf.WellKnownTypes.Value>> SerialiseArgs(VolumeAttachV2Args args) {
