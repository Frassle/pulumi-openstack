...
namespace Pulumi.Openstack.Vpnaas {
	...
	public sealed class IpSecPolicyArgsLifetime : Pulumi.IIOProtobuf {
	...
	} // IpSecPolicyArgsLifetime

	public sealed class IpSecPolicyLifetime : Pulumi.IIOProtobuf {
		public Pulumi.IO<string> Units { get; set; }
		public Pulumi.IO<int> Value { get; set; }
		...
		public static IpSecPolicyLifetime FromProtobuf(Google.Protobuf.WellKnownTypes.Value value) {
			var obj = value.StructValue;
			return new IpSecPolicyLifetime() {
	...
	public struct IpSecPolicyArgs {
		...
		/// </summary>
		public Pulumi.IO<string> EncapsulationMode { get; set; }
		...
		/// Default is 3600.
		/// </summary>
		public Pulumi.IO<Pulumi.IO<IpSecPolicyArgsLifetime>[]> Lifetimes { get; set; }
		...
		/// </summary>
		public Pulumi.IO<string> TransformProtocol { get; set; }
	...
	/// </summary>
	public class IpSecPolicy : Pulumi.CustomResource {
		/// <summary>
		/// The authentication hash algorithm. Valid values are sha1, sha256, sha384, sha512.
		/// Default is sha1. Changing this updates the algorithm of the existing policy.
		/// </summary>
		...
		/// Default is 3600.
		/// </summary>
		public Pulumi.IO<IpSecPolicyLifetime[]> Lifetimes { get; set; }
		...
		public IpSecPolicy(string name, IpSecPolicyArgs args, Pulumi.ResourceOptions opts = default(Pulumi.ResourceOptions))
			: base("openstack:vpnaas/ipSecPolicy:IpSecPolicy", name, SerialiseArgs(args), opts) {
			...
			EncapsulationMode = Outputs["encapsulationMode"].Select(item => Protobuf.ToString(item));
			EncryptionAlgorithm = Outputs["encryptionAlgorithm"].Select(item => Protobuf.ToString(item));
			Lifetimes = Outputs["lifetimes"].Select(item => Protobuf.ToList(item, item1 => IpSecPolicyLifetime.FromProtobuf(item1)));
			...
			TransformProtocol = Outputs["transformProtocol"].Select(item => Protobuf.ToString(item));
		...
		private static Dictionary<string, Pulumi.IO<Google.Protobuf.WellKnownTypes.Value>> SerialiseArgs(IpSecPolicyArgs args) {
			...
			props["encapsulationMode"] = Protobuf.ToProtobuf(args.EncapsulationMode);
			...
			props["transformProtocol"] = Protobuf.ToProtobuf(args.TransformProtocol);
