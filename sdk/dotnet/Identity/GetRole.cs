...
namespace Pulumi.Openstack.Identity {
	...
	public static partial class IdentityModule {
		...
		/// </summary>
		public static System.Threading.Tasks.Task<GetRoleResult> GetRole(GetRoleArgs args, Pulumi.InvokeOptions opts = default(Pulumi.InvokeOptions)) {
			...
			var task = Pulumi.Runtime.InvokeAsync("openstack:identity/getRole:getRole", invokeArgs, opts);
